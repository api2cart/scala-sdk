...
case class ProductVariantUpdateBatch (
  ...
  nestedItemsUpdateBehaviour: Option[ProductVariantUpdateBatchEnums.NestedItemsUpdateBehaviour] = None,
  ...
  payload: Seq[ProductVariantUpdateBatchPayloadInner]
) extends ApiModel

object ProductVariantUpdateBatchEnums {
