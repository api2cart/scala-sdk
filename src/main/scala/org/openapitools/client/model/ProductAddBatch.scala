...
case class ProductAddBatch (
  ...
  nestedItemsUpdateBehaviour: Option[ProductAddBatchEnums.NestedItemsUpdateBehaviour] = None,
  ...
  payload: Seq[ProductAddBatchPayloadInner]
) extends ApiModel

object ProductAddBatchEnums {
