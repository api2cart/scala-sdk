...
class AccountApi(baseUrl: String) {
  ...
  def accountCartList(storeUrl: Option[String] = None, storeKey: Option[String] = None, requestFromDate: Option[String] = None, requestToDate: Option[String] = None, customLabel: Option[String] = None, params: Option[String] = None, exclude: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[AccountCartList200Response] =
    ApiRequest[AccountCartList200Response](ApiMethods.GET, baseUrl, "/account.cart.list.json", "application/json")
      ...
      .withQueryParam("custom_label", customLabel)
   ...
   * @param miraklApiKey Mirakl API Key
   ...
   * @param nopcommerceToken Access token authorizing the app to access resources on behalf of a user
   * @param nopcommerceSecret nopCommerce webhook signing secret generated by the Api2Cart.Connector plugin. Optional when connecting a store, but required to receive webhooks from it.
   ...
   * @param walmartRefreshToken Walmart refresh token received by a Solution Provider application through the Walmart App Store authorization. When it is set, walmart_client_id and walmart_client_secret are the credentials of that application, not of the seller. Must be used together with walmart_seller_id and is supported only for walmart_region = 'us'
   * @param walmartSellerId Walmart seller id the refresh token was issued for, sent as the WM_PARTNER.ID header. Must be used together with walmart_refresh_token and is supported only for walmart_region = 'us'
  ...
  def accountConfigUpdate(replaceParameters: Option[Boolean] = None, newStoreUrl: Option[String] = None, newStoreKey: Option[String] = None, customLabel: Option[String] = None, bridgeUrl: Option[String] = None, storeRoot: Option[String] = None, dbTablesPrefix: Option[String] = None, userAgent: Option[String] = None, `3dcartPrivateKey`: Option[String] = None, `3dcartAccessToken`: Option[String] = None, `3dcartapiApiKey`: Option[String] = None, amazonSpClientId: Option[String] = None, amazonSpClientSecret: Option[String] = None, amazonSpRefreshToken: Option[String] = None, amazonSpAwsRegion: Option[String] = None, amazonSpApiEnvironment: Option[String] = None, amazonSellerId: Option[String] = None, aspdotnetstorefrontApiUser: Option[String] = None, aspdotnetstorefrontApiPass: Option[String] = None, americommerceAppId: Option[String] = None, americommerceAppSecret: Option[String] = None, americommerceAccessToken: Option[String] = None, americommerceRefreshToken: Option[String] = None, bigcommerceapiAdminAccount: Option[String] = None, bigcommerceapiApiPath: Option[String] = None, bigcommerceapiApiKey: Option[String] = None, bigcommerceapiClientId: Option[String] = None, bigcommerceapiAccessToken: Option[String] = None, bigcommerceapiContext: Option[String] = None, bolApiKey: Option[String] = None, bolApiSecret: Option[String] = None, bolRetailerId: Option[Int] = None, demandwareClientId: Option[String] = None, demandwareApiPassword: Option[String] = None, demandwareUserName: Option[String] = None, demandwareUserPassword: Option[String] = None, ebayClientId: Option[String] = None, ebayClientSecret: Option[String] = None, ebayRuname: Option[String] = None, ebayAccessToken: Option[String] = None, ebayRefreshToken: Option[String] = None, ebayEnvironment: Option[String] = None, ebaySiteId: Option[Int] = None, ecwidAcessToken: Option[String] = None, ecwidStoreId: Option[String] = None, lazadaAppId: Option[String] = None, lazadaAppSecret: Option[String] = None, lazadaRefreshToken: Option[String] = None, lazadaRegion: Option[String] = None, etsyKeystring: Option[String] = None, etsySharedSecret: Option[String] = None, etsyAccessToken: Option[String] = None, etsyTokenSecret: Option[String] = None, etsyClientId: Option[String] = None, etsyRefreshToken: Option[String] = None, facebookAppId: Option[String] = None, facebookAppSecret: Option[String] = None, facebookAccessToken: Option[String] = None, facebookBusinessId: Option[String] = None, netoApiKey: Option[String] = None, netoApiUsername: Option[String] = None, shoplineAccessToken: Option[String] = None, shoplineAppKey: Option[String] = None, shoplineAppSecret: Option[String] = None, shoplineSharedSecret: Option[String] = None, shopifyAccessToken: Option[String] = None, shopifyClientId: Option[String] = None, shopifyApiKey: Option[String] = None, shopifyApiPassword: Option[String] = None, shopifySharedSecret: Option[String] = None, shopeePartnerId: Option[String] = None, shopeePartnerKey: Option[String] = None, shopeeShopId: Option[String] = None, shopeeRefreshToken: Option[String] = None, shopeeRegion: Option[String] = None, shopeeEnvironment: Option[String] = None, shoplazzaAccessToken: Option[String] = None, shoplazzaSharedSecret: Option[String] = None, mivaAccessToken: Option[String] = None, mivaSignature: Option[String] = None, miraklApiKey: Option[String] = None, shopwareAccessKey: Option[String] = None, unasApiKey: Option[String] = None, shopwareApiKey: Option[String] = None, shopwareApiSecret: Option[String] = None, bigcartelUserName: Option[String] = None, bigcartelPassword: Option[String] = None, bricklinkConsumerKey: Option[String] = None, bricklinkConsumerSecret: Option[String] = None, bricklinkToken: Option[String] = None, bricklinkTokenSecret: Option[String] = None, nopcommerceToken: Option[String] = None, nopcommerceSecret: Option[String] = None, volusionLogin: Option[String] = None, volusionPassword: Option[String] = None, walmartClientId: Option[String] = None, walmartClientSecret: Option[String] = None, walmartEnvironment: Option[String] = None, walmartChannelType: Option[String] = None, walmartRegion: Option[String] = None, walmartRefreshToken: Option[String] = None, walmartSellerId: Option[String] = None, squareClientId: Option[String] = None, squareClientSecret: Option[String] = None, squareRefreshToken: Option[String] = None, squarespaceApiKey: Option[String] = None, squarespaceClientId: Option[String] = None, squarespaceClientSecret: Option[String] = None, squarespaceAccessToken: Option[String] = None, squarespaceRefreshToken: Option[String] = None, hybrisClientId: Option[String] = None, hybrisClientSecret: Option[String] = None, hybrisUsername: Option[String] = None, hybrisPassword: Option[String] = None, hybrisWebsites: Seq[String], lightspeedApiKey: Option[String] = None, lightspeedApiSecret: Option[String] = None, commercehqApiKey: Option[String] = None, commercehqApiPassword: Option[String] = None, wcConsumerKey: Option[String] = None, wcConsumerSecret: Option[String] = None, magentoConsumerKey: Option[String] = None, magentoConsumerSecret: Option[String] = None, magentoAccessToken: Option[String] = None, magentoTokenSecret: Option[String] = None, prestashopWebserviceKey: Option[String] = None, wixAppId: Option[String] = None, wixAppSecretKey: Option[String] = None, wixInstanceId: Option[String] = None, wixRefreshToken: Option[String] = None, mercadoLibreAppId: Option[String] = None, mercadoLibreAppSecretKey: Option[String] = None, mercadoLibreRefreshToken: Option[String] = None, zidClientId: Option[Int] = None, zidClientSecret: Option[String] = None, zidAccessToken: Option[String] = None, zidAuthorization: Option[String] = None, zidRefreshToken: Option[String] = None, jumpsellerClientId: Option[String] = None, jumpsellerClientSecret: Option[String] = None, jumpsellerRefreshToken: Option[String] = None, jumpsellerLogin: Option[String] = None, jumpsellerAuthtoken: Option[String] = None, flipkartClientId: Option[String] = None, flipkartClientSecret: Option[String] = None, allegroClientId: Option[String] = None, allegroClientSecret: Option[String] = None, allegroAccessToken: Option[String] = None, allegroRefreshToken: Option[String] = None, allegroEnvironment: Option[String] = None, zohoClientId: Option[String] = None, zohoClientSecret: Option[String] = None, zohoRefreshToken: Option[String] = None, zohoRegion: Option[String] = None, tiendanubeUserId: Option[Int] = None, tiendanubeAccessToken: Option[String] = None, tiendanubeClientSecret: Option[String] = None, ottoClientId: Option[String] = None, ottoClientSecret: Option[String] = None, ottoAppId: Option[String] = None, ottoRefreshToken: Option[String] = None, ottoEnvironment: Option[String] = None, ottoAccessToken: Option[String] = None, tiktokshopAppKey: Option[String] = None, tiktokshopAppSecret: Option[String] = None, tiktokshopRefreshToken: Option[String] = None, tiktokshopAccessToken: Option[String] = None, sallaClientId: Option[String] = None, sallaClientSecret: Option[String] = None, sallaRefreshToken: Option[String] = None, sallaAccessToken: Option[String] = None, temuAppKey: Option[String] = None, temuAppSecret: Option[String] = None, temuAccessToken: Option[String] = None, temuRegion: Option[String] = None, scapiClientId: Option[String] = None, scapiClientSecret: Option[String] = None, scapiOrganizationId: Option[String] = None, scapiShortCode: Option[String] = None, scapiScopes: Option[String] = None, idempotencyKey: Option[String] = None)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[AccountConfigUpdate200Response] =
    ApiRequest[AccountConfigUpdate200Response](ApiMethods.PUT, baseUrl, "/account.config.update.json", "application/json")
      ...
      .withQueryParam("americommerce_app_id", americommerceAppId)
      .withQueryParam("americommerce_app_secret", americommerceAppSecret)
      .withQueryParam("americommerce_access_token", americommerceAccessToken)
      .withQueryParam("americommerce_refresh_token", americommerceRefreshToken)
      ...
      .withQueryParam("shopify_client_id", shopifyClientId)
      ...
      .withQueryParam("mirakl_api_key", miraklApiKey)
      .withQueryParam("shopware_access_key", shopwareAccessKey)
      .withQueryParam("unas_api_key", unasApiKey)
      ...
      .withQueryParam("nopcommerce_token", nopcommerceToken)
      .withQueryParam("nopcommerce_secret", nopcommerceSecret)
      ...
      .withQueryParam("walmart_refresh_token", walmartRefreshToken)
      .withQueryParam("walmart_seller_id", walmartSellerId)
      ...
      .withQueryParam("jumpseller_client_id", jumpsellerClientId)
      .withQueryParam("jumpseller_client_secret", jumpsellerClientSecret)
      .withQueryParam("jumpseller_refresh_token", jumpsellerRefreshToken)
      .withQueryParam("jumpseller_login", jumpsellerLogin)
      .withQueryParam("jumpseller_authtoken", jumpsellerAuthtoken)
      ...
      .withQueryParam("scapi_client_id", scapiClientId)
      .withQueryParam("scapi_client_secret", scapiClientSecret)
      .withQueryParam("scapi_organization_id", scapiOrganizationId)
      .withQueryParam("scapi_short_code", scapiShortCode)
      .withQueryParam("scapi_scopes", scapiScopes)
