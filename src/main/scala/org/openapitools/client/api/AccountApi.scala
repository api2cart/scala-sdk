...
object AccountApi {
  ...
  def apply(baseUrl: String = "https://api.api2cart.com/v1.1") = new AccountApi(baseUrl)
}
...
class AccountApi(baseUrl: String) {
   ...
   */
  def accountCartList(params: Option[String] = None, exclude: Option[String] = None, requestFromDate: Option[String] = None, requestToDate: Option[String] = None, storeUrl: Option[String] = None, storeKey: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[AccountCartList200Response] =
   ...
   */
  def accountFailedWebhooks(count: Option[Int] = None, start: Option[Int] = None, ids: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[AccountFailedWebhooks200Response] =
