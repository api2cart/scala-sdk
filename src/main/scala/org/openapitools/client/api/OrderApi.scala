...
class OrderApi(baseUrl: String) {
   ...
   */
  def orderInfo(id: Option[String] = None, orderId: Option[String] = None, storeId: Option[String] = None, params: Option[String] = None, responseFields: Option[String] = None, exclude: Option[String] = None, enableCache: Option[Boolean] = None, useLatestApiVersion: Option[Boolean] = None, roundingPrecision: Option[Int] = None, allowUserDefinedOrderStatuses: Option[Boolean] = None)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[OrderInfo200Response] =
    ApiRequest[OrderInfo200Response](ApiMethods.GET, baseUrl, "/order.info.json", "application/json")
      ...
      .withQueryParam("allow_user_defined_order_statuses", allowUserDefinedOrderStatuses)
