...
[**productVariantPriceDeleteWithHttpInfo**](ProductApi.md#productVariantPriceDeleteWithHttpInfo) | **DELETE** /product.variant.price.delete.json | product.variant.price.delete
...
object Example extends App {
    ...
    val responseFields: String = {pagination,result{attribute}} // String | Set this parameter to choose which entity fields to retrieve. Use comma-separated field names in curly braces, nested to match the response structure, e.g. {result{product{id,name}}}. The wildcard * returns every field at a level: {*} gives the whole response, {result{product{*}}} all product fields.

    val params: String = attribute_id,name // String | Important! Parameter deprecated, use response_fields instead. Set this parameter in order to choose which entity fields you want to retrieve

    val exclude: String = attribute_id,name // String | Important! Parameter deprecated, use response_fields instead. Set this parameter in order to choose which entity fields you want to ignore. Works only if parameter `params` equal force_all
...
object Example extends App {
    ...
    val responseFields: String = {result{children{id,parent_id,sku,upc,images,combination}}} // String | Set this parameter to choose which entity fields to retrieve. Use comma-separated field names in curly braces, nested to match the response structure, e.g. {result{product{id,name}}}. The wildcard * returns every field at a level: {*} gives the whole response, {result{product{*}}} all product fields.
...
object Example extends App {
    ...
    val responseFields: String = {return_message,pagination,result{currency}} // String | Set this parameter to choose which entity fields to retrieve. Use comma-separated field names in curly braces, nested to match the response structure, e.g. {result{product{id,name}}}. The wildcard * returns every field at a level: {*} gives the whole response, {result{product{*}}} all product fields.

    val params: String = name,iso3,default,avail // String | Important! Parameter deprecated, use response_fields instead. Set this parameter in order to choose which entity fields you want to retrieve

    val exclude: String = name,iso3,default,avail // String | Important! Parameter deprecated, use response_fields instead. Set this parameter in order to choose which entity fields you want to ignore. Works only if parameter `params` equal force_all
...
object Example extends App {
    ...
    val responseFields: String = {result{id,name,price,images}} // String | Set this parameter to choose which entity fields to retrieve. Use comma-separated field names in curly braces, nested to match the response structure, e.g. {result{product{id,name}}}. The wildcard * returns every field at a level: {*} gives the whole response, {result{product{*}}} all product fields.
...
object Example extends App {
    ...
    val responseFields: String = {return_code,pagination,result{product{id,name,price,images}}} // String | Set this parameter to choose which entity fields to retrieve. Use comma-separated field names in curly braces, nested to match the response structure, e.g. {result{product{id,name}}}. The wildcard * returns every field at a level: {*} gives the whole response, {result{product{*}}} all product fields.
...
object Example extends App {
    ...
    val params: String = id,name,sort_order // String | Important! Parameter deprecated, use response_fields instead. Set this parameter in order to choose which entity fields you want to retrieve

    val exclude: String = id,name,sort_order // String | Important! Parameter deprecated, use response_fields instead. Set this parameter in order to choose which entity fields you want to ignore. Works only if parameter `params` equal force_all
...
object Example extends App {
    ...
    val optionValue: String = green // String | Defines option value that has to be added
...
ApiRequest[[**ProductOptionValueAdd200Response**](ProductOptionValueAdd200Response.md)]
...
> productOptionValueAssign(productOptionValueAssignRequest): ApiRequest[ProductOptionValueAssign200Response]
...
ApiRequest[[**ProductOptionValueAssign200Response**](ProductOptionValueAssign200Response.md)]
...
> productOptionValueDelete(productOptionValueDeleteRequest): ApiRequest[AttributeDelete200Response]
...
object Example extends App {
    ...
    val productId: String = 10 // String | Defines product id where the option value should be deleted

    val storeId: String = 1 // String | Store Id
    
    val request = apiInstance.productOptionValueDelete(optionId, optionValueId, productId, storeId)
    val response = apiInvoker.execute(request)
...
> productOptionValueUpdate(productOptionValueUpdateRequest): ApiRequest[AccountConfigUpdate200Response]
...
object Example extends App {
    ...
    val price: BigDecimal = 99.9 // BigDecimal | Defines new product option price

    val quantity: BigDecimal = 6 // BigDecimal | Defines new products' options quantity
...
> productPriceAdd(productPriceAddRequest): ApiRequest[CartValidate200Response]
...
> productPriceDelete(productPriceDeleteRequest): ApiRequest[AttributeDelete200Response]
...
object Example extends App {
    ...
    val request = apiInstance.productPriceDelete(productId, groupPrices, storeId)
    val response = apiInvoker.execute(request)
...
> productPriceUpdate(productPriceUpdateRequest): ApiRequest[AccountConfigUpdate200Response]
...
> productReviewList(productReviewListRequest): ApiRequest[ModelResponseProductReviewList]
...
ApiRequest[[**ModelResponseProductReviewList**](ModelResponseProductReviewList.md)]
...
> productStoreAssign(productStoreAssignRequest): ApiRequest[AccountConfigUpdate200Response]
...
> productTaxAdd(productTaxAddRequest): ApiRequest[ProductTaxAdd200Response]
...
ApiRequest[[**ProductTaxAdd200Response**](ProductTaxAdd200Response.md)]
...
> productUpdate(productUpdateRequest): ApiRequest[AccountConfigUpdate200Response]
...
> productUpdateBatch(productUpdateBatchRequest): ApiRequest[CategoryAddBatch200Response]
...
> productVariantAdd(productVariantAddRequest): ApiRequest[ProductVariantAdd200Response]
...
ApiRequest[[**ProductVariantAdd200Response**](ProductVariantAdd200Response.md)]
...
> productVariantAddBatch(productVariantAddBatchRequest): ApiRequest[CategoryAddBatch200Response]
...
object Example extends App {
    ...
    val request = apiInstance.productVariantDelete(id, productId, storeId)
    val response = apiInvoker.execute(request)
...
> productVariantDeleteBatch(productVariantDeleteBatchRequest): ApiRequest[CategoryAddBatch200Response]
...
> productVariantImageAdd(productVariantImageAddRequest): ApiRequest[ProductVariantImageAdd200Response]
...
ApiRequest[[**ProductVariantImageAdd200Response**](ProductVariantImageAdd200Response.md)]
...
> productVariantImageDelete(productVariantImageDeleteRequest): ApiRequest[AttributeDelete200Response]
...
object Example extends App {
    ...
    val request = apiInstance.productVariantImageDelete(productId, productVariantId, id, storeId)
    val response = apiInvoker.execute(request)
...
> productVariantPriceDelete(productVariantPriceDeleteRequest): ApiRequest[AttributeDelete200Response]
...
object Example extends App {
    ...
    val groupPrices: String = group_prices=6,8,9 // String | Defines variants's group prices

    val storeId: String = 1 // String | Store Id
    
    val request = apiInstance.productVariantPriceDelete(id, productId, groupPrices, storeId)
    val response = apiInvoker.execute(request)
...
> productVariantPriceUpdate(productVariantPriceUpdateRequest): ApiRequest[AccountConfigUpdate200Response]
...
> productVariantUpdate(productVariantUpdateRequest): ApiRequest[AccountConfigUpdate200Response]
...
> productVariantUpdateBatch(productVariantUpdateBatchRequest): ApiRequest[CategoryAddBatch200Response]
