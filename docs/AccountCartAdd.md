...
------------ | ------------- | ------------- | -------------
**cartId** | [**CartId**](#CartId) | Store’s identifier which you can get from cart_list method | 
...
**temuRegion** | [**TemuRegion**](#TemuRegion) | Temu API endpoint Region. | 
